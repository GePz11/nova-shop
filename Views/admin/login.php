                ...
                <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
                    <div class="col mx-auto">
                        <div class="mb-4 text-center">
                            <img src="<?php  echo BASE_URL; ?>assets/images/nebula.png" width="180" alt="LOGO" />
                        </div>
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="form-body">
                                        <form class="row g-3" id="formulario">
                                            <div class="col-12">
                                                ...
                                                <input type="email" class="form-control" id="email" name="email" value="alessaortiz1212@gmail.com" placeholder="Correo Electronico">
                                            </div>
                                            <div class="col-12">
