    ...
    function enviarCorreo()
    {
        if (isset($_POST['correo']) && isset($_POST['token'])) {
            ...
            try {
                ...
                //Recipients
                $mail->setFrom('alexamoralescr23@gmail.com', TITLE);
                $mail->addAddress($_POST['correo']);

                //Content
                $mail->isHTML(true);                                  //Set email format to HTML
                $mail->Subject = 'Mensaje desde la: ' . TITLE;
                $mail->Body    = 'Para verificar tu correo en nuestra tienda <a href = "' . BASE_URL . 'clientes/verificarCorreo/' . $_POST['token'] . '" >CLIC AQUI</a>';
...
//sb-j4aix42419816@personal.example.com
//+t&)R(0%
